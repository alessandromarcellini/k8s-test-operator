...
type ToyStatus struct {
	...
	// conditions represent the current state of the Toy resource.
...
type Toy struct {
	...
	// spec defines the desired state of Toy
	// +required
	Spec ToySpec `json:"spec"`

	// status defines the observed state of Toy
	// +optional
	Status ToyStatus `json:"status,omitzero"`
}
